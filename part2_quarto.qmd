...
genomics = "~/GitHub/part2scorer/data/brain"
...
```{r traitement1, eval=FALSE, include=FALSE}
...
clusters <- objet_seurat@meta.data[["seurat_clusters"]]
```
...
# tissue_list <- c("UTERUS", "TRACHEA", "TONGUE", "THYMUS", "SUBCUTANEOUS_ADIPOSE", "SPLEEN", "SKIN", "PANCREAS", "MESENTERIC_ADIPOSE", "MARROW", "MAMMARY_GLAND", "LUNG", "LIVER", "LIMB", "LARGE_INTESTINE", "HEART", "GONADAL_ADIPOSE", "ADIPOSE", "DIAPHRAGM", "BRAIN", "BRAIN_NON_MYELOID", "BRAIN_MYELOID", "BLADDER", "AORTA", "ORGANOGENESIS", "NOTOCHORD", "NEURAL") 
